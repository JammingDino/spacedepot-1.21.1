...
public class SpaceReceiverScreen extends AbstractContainerScreen<SpaceReceiverMenu> {
    // Use the vanilla Dispenser GUI texture
    private static final ResourceLocation TEXTURE = ResourceLocation.withDefaultNamespace("textures/gui/container/dispenser.png");

    public SpaceReceiverScreen(SpaceReceiverMenu menu, Inventory playerInventory, Component title) {
